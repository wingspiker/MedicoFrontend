...
export const getCurrentPlanDetails = async (email) => {
  ...
  return axios
    .get(url + `/api/subscription/${email}/current-plan`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const getDuePayment = async (email, subscriptionId) => {
  ...
  return axios
    .get(
      url + `/api/subscription/${email}/due-payment/?newPlan=${subscriptionId}`,
      config
    )
    .then((response) => {
      // Handle successful response
...
export const getPaymentError = async (email) => {
  ...
  return axios
    .get(url + `/api/company/get-payment-error/${email}`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const payDue = async (email, subscriptionId, payment) => {
  ...
  return axios
    .post(
      url + `/api/subscription/${email}/pay-due/${subscriptionId}`,
      payment,
      config
    )
    .then((response) => {
...
export const verifySubscriptionPayment = async (companyEmail) => {
  ...
  return axios
    .post(url + `/api/subscription/${companyEmail}/verify-payment`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const changeChargesType = async (changeObj) => {
  ...
  return axios
    .post(url + `/api/company/change-charges-type`, changeObj, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const getAllPendingSubscriptions = async () => {
  ...
  return axios
    .get(url + `/api/company/pending-payment-verifications-subsription`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const getAllPendingPercentages = async () => {
  ...
  return axios
    .get(url + `/api/company/pending-payment-verifications-percentage`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const getAllPendingPercentagesBills = async () => {
  ...
  return axios
    .get(url + `/api/company/get-pending-monthly-payment-verifications`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const getMonthlyTurnOver = async (companyEmail) => {
  ...
  return axios
    .get(url + `/api/company/${companyEmail}/monthly-turnover`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const completepayment = async (billObject, companyEmail) => {
  ...
  return axios
    .post(url + `/api/company/${companyEmail}/mark-paid`, billObject, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const verifyBillPayment = async (verifyObject, companyEmail) => {
  ...
  return axios
    .post(
      url + `/api/company/${companyEmail}/mark-payment-verified`,
      verifyObject,
      config
    )
    .then((response) => {
...
export const verifyPercentage = async (verifyObject) => {
  ...
  return axios
    .post(url + `/api/company/set-percentage-value`, verifyObject, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
