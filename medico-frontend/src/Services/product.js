...
export const addProduct = async (productDetails) => {
  ...
  return axios
    .post(url + "/api/product", productDetails, config)
    .then((response) => {
...
export const getProducts = async (email) => {
  ...
  return axios
    .get(url + `/api/product/products-by-company?companyEmail=${email}`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const getProductById = async (pid) => {
  ...
  return axios
    .get(url + `/api/product/${pid}`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const deleteProductById = async (pid) => {
  ...
  return axios
    .delete(url + `/api/product/${pid}`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
...
export const getAdminSellingCompanies = async () => {
  ...
  return axios
    .get(url + `/api/product/admin-selling`, config)
    .then((response) => {
      // Handle successful response
      return response.data; // Return data if needed
    })
