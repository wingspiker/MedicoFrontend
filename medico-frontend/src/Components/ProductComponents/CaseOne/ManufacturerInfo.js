...
function ManufacturerInformation({ register, errors, allowReturn }) {
  return (
    <div className="p-4 border rounded-2xl flex flex-col md:flex-col md:justify-between mt-4 max-w-5xl bg-cyan-50">
      <div className="text-2xl text-cyan-700 mb-4 md:mb-0 md:mr-4 font-medium">
      ...
      <div className="flex py-5">
        ...
        <div className="form-group flex flex-col px-10">
          <label className="text-black">Allow Exchange</label>
          <div className="flex">
        ...
        <div className="form-group flex flex-col">
          <label className="text-black">Allow Return</label>
          <div className="flex">
