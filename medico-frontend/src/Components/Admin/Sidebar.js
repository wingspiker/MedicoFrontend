...
import { MdHome, MdGroups, MdLocalOffer, MdOutlineManageAccounts, MdSubscriptions   } from "react-icons/md";
          ...
          {isOpen ? (
            <div className=" flex items-center gap-3">
              <img
                ...
                className="w-12 h-10"
              />
              <h1 className="text-3xl font-bold">Medico <p className=" text-red-500 text-sm text-right -me-6 -mt-2">Admin</p> </h1>
            </div>
          ) : (
            ""
          )}
